...
<x-slot:heading>
    ...
    <!-- <h1>Hello from Contact page of folder demo2-app </h1> -->
...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    ...
    <p class="mt-2 text-lg leading-8 text-gray-600">"We'd love to hear from you! Whether you have a question, feedback, or need assistance, our team is here to help."
                "Reach out to us with any inquiries or support needs. We're just a message away."</p>
  </div>
